...
// --- IMPORTS GERAIS (BANNER, CARDS VEM AÍ) ---
...
// =========================================================================
const openWhenList = [
// ADICIONADO: customDescription: "" (campo que será preenchido depois)
...
              <Play className="w-7 h-7 fill-black" /> Assistir</button>
          </a>
          
...
            <Info className="w-7 h-7" /> Mais Informações</button>
        </div>
...
      {/* =============================================== */}
      <div className="relative z-20 px-4 md:px-12 pb-20 bg-transparent pt-10 space-y-16">
        
        {/* ------------------------------------------------ */}
        {/* SEÇÃO 1: VEM AÍ... (Principal e Clicável) */}
        {/* ------------------------------------------------ */}
        <div>
...
        {/* ------------------------------------------------- */}
        {/* SEÇÃO 2: COISAS QUE ME LEMBRAM VOCÊ (Apenas Galeria) */}
        {/* ------------------------------------------------- */}
        <div>
...
            
            {/* Cards da Galeria (Não-clicáveis) */}
...
        
        {/* ------------------------------------------------ */}
        {/* SEÇÃO 3: ABRA QUANDO... (Abre Modal Personalizado) */}
        {/* ------------------------------------------------ */}
        <div>
...
                onClick={() => {
                    ...
                    setSelectedMovie({
                        ...baseMovieData,
                        // TÍTULO PRINCIPAL = VAZIO (REMOVE O TEXTO GRANDE)
                        title: "", 
                        // SUBTÍTULO = FRASE DA EMOÇÃO
                        subtitle: item.title, 
                        // DESCRIÇÃO = VAZIA POR ENQUANTO (customDescription)
